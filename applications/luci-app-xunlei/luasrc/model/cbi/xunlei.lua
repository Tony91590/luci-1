...
xlan = s:taboption("basic", Value, "xlan", "xlan", "<br />xlan地址,不能跟LAN同一网段")
xlan_mask = s:taboption("basic", Value, "xlan_mask", "xlan mask", "<br />xlan mask地址")
xlan_mac = s:taboption("basic", Value, "xlan_mac", "xlan mac", "<br />xlan mac地址")

--button_update = s:taboption("basic", Button, "_button_update" ,"关闭迅雷")
--button_update.inputtitle = translate("关闭迅雷")
--button_update.inputstyle = "apply"
--function button_update.write(self, section)
--        luci.sys.call("/etc/init.d/./xunlei stop")
--end
